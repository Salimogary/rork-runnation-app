# RunNation Country Admin Terms and Conditions
...
- Country Admin is responsible for assigned-country orders and stock, including delivery support, fulfilment updates, product quantities, and catalogue accuracy.
- Country Admin is responsible for assigned-country events, enrollments, payments, club administration, and club or organiser requests, ensuring decisions are accurate, fair, and supported by clear records.
- Country Admin is responsible for assigned-country activity uploads, other source runs, magazine review, WhatsApp group oversight, and reports where these support country operations.
- Country Admin must escalate safety, abuse, payment, role, or data concerns that require Global Admin authority.

## Acceptance

- By accepting, you agree to carry out Country Admin responsibilities only within your assigned scope and only for legitimate RunNation work.