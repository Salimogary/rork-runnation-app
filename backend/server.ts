...
<html lang="en">
  <head>
    ...
    <meta
      name="description"
      content="Instructions for requesting deletion of a RunNation account and associated data."
    />
    <style>
      :root {
        color-scheme: light;
  ...
  <body>
    <main>
      <article>
        ...
        <p class="summary">
          This page explains how RunNation users can request deletion of their account and associated data.
        </p>

        <div class="notice">
          <strong>App name:</strong> RunNation<br />
          <strong>Developer:</strong> RunNation / Salim Ogary
        </div>
        ...
        <p>
          If you cannot access the app, contact RunNation support using the official support channel provided by the developer and include the account email, username, or phone number linked to your account.
        </p>
        ...
        <p>
          Some information may be retained for a limited period where necessary for safety, fraud prevention, moderation, dispute resolution, legal compliance, financial/accounting records, or backup integrity.
        </p>
        <p>
          Records retained for these reasons are restricted to the purposes above and are no longer used as an active RunNation account.
        </p>

        <h2>Deleting Some Data Without Deleting The Account</h2>
        <p>
          Users may also request removal or correction of some account data, uploaded photos, posts, submissions, or other content without deleting the full account. Use the same in-app support or feedback process and clearly describe the data you want removed or corrected.
        </p>

        <h2>Processing Time</h2>
        <p>
          RunNation aims to review deletion requests promptly. Some deletion or anonymization steps may take additional time where records must be checked for security, moderation, legal, financial, or operational reasons.
        </p>

        <h2>Privacy Policy</h2>
        <p>
          For more information about RunNation privacy practices, see the RunNation Privacy Policy and Terms of Use inside the app under <strong>Settings</strong>.
        </p>
      </article>
...
app.get(["/delete-account", "/delete-account/"], (_req, res) => {
